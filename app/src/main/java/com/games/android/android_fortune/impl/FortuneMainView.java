...
public class FortuneMainView extends SurfaceView implements Runnable{
    FortuneMainGame game;
    Bitmap framebuffer;
    ...
    /** コンストラクタ */
    public FortuneMainView(FortuneMainGame game, Bitmap framebuffer){
        super(game);
        this.game = game;
